...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${x("Risk",l)}
  ${x("Watchlist",v)}
</Workbook>`}function J(d,t,r){const c=new Blob([d],{type:r}),s=URL.createObjectURL(c),l=document.createElement("a");l.href=s,l.download=t,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(s)}function Q(d,t){const r=window.open("","_blank","width=960,height=720");if(!r)return;const c=t.watchlist.length>0?t.watchlist.map(s=>`
              <tr>
